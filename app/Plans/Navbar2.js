  ...
  return (
    <nav className="flex justify-between px-3 pt-12 w-full h-[8vh] items-center relative z-20">
      ...
      <ul className="lg:flex justify-evenly hidden w-[20vw] font-extralight"  >
       ...
       <li className="cursor-pointer hover:text-orange-300 transition-colors duration-200 scroll-smooth"> <Link href="#him">Him</Link></li>
       <li className="cursor-pointer hover:text-orange-300 transition-colors duration-200 scroll-smooth"> <Link href="#her">Her</Link></li>
      </ul> {/* Mobile Dropdown Menu */}
      <ul
        ref={menuRef}
        className={`${
          clicked ? "flex opacity-100 scale-100" : " flex opacity-0 scale-90 pointer-events-none"
        } transition-all duration-500 ease-in-out absolute flex-col pointer-events-auto justify-evenly w-[190px] h-[190px] font-extralight z-50 right-[82px] items-center top-[25px] rounded-[16px] bg-gradient-to-bl from-[rgba(255,255,255,0.22)] to-[rgba(255,255,255,0.1)] shadow-[0px_0px_11px_2px_white] backdrop-blur-sm ring-2 ring-slate-400`}
      ...
      >
        ...
        <li className="cursor-pointer hover:text-orange-300 transition-colors duration-200"><Link href="/#contact" >Contact</Link></li>
         <hr className="w-[80%]" />
        <li className="cursor-pointer hover:text-orange-300 transition-colors duration-200"><Link href="#him" >Him</Link></li>
         <hr className="w-[80%]" />
        <li className="cursor-pointer hover:text-orange-300 transition-colors duration-200"><Link href="#her">Her</Link></li>
      </ul>
